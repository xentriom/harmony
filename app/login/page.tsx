...
//       {/* Login Container */}
//       <Card className="z-10 container flex flex-row w-full max-w-3xl p-10 bg-slate-700 rounded-xl overflow-hidden shadow-lg">
//         {/* Left Section (Login Form) */}
//         <CardContent className="flex flex-col justify-center w-full p-0">
...
//               <label className="text-gray-400 text-sm mb-1 block font-bold">EMAIL OR PHONE NUMBER</label>
//               <Input type="email" />
//             </div>

//             <div className="text-left mb-2">
//               <label className="text-gray-400 text-sm mb-1 block font-bold">PASSWORD</label>
//               <Input type="password" />
//             </div>
...
//             <Button className="w-full bg-blue-500 hover:bg-blue-600 text-white">Login</Button>
...
//           <QrCodeIcon className="w-20 h-20 text-white" />
